...
all data are saved in avro
data are getting from hdfs file and  saved in hive tables
All file are in Avro format

Please notice that all avro schemas saves in hdfs:///schemas/  folder
 */
